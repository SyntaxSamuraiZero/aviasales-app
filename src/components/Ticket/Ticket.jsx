  ...
  return (
    <li className={styles['tickets-list__item']}>
      <div className={styles['tickets-list__price-container']}>
        <span className={styles['tickets-list__price']}>{ticket.price.toLocaleString('ru-RU')} Р</span>
        <img
          ...
          <React.Fragment key={index}>
            <div className={styles['tickets-list__details']}>
              ...
              <span className={styles['tickets-list__value']}>
                ...
                {format(addMinutes(new Date(segment.date), segment.duration), 'HH:mm')}
              </span>
            </div>
            <div className={styles['tickets-list__details']}>
            ...
            <div className={styles['tickets-list__details']}>
              <span className={styles['tickets-list__label']}>
                {segment.stops.length} {getPluralForm(segment.stops.length, ['пересадка', 'пересадки', 'пересадок'])}
              </span>
              <span className={styles['tickets-list__value']}>{segment.stops.join(', ')}</span>
            </div>
          </React.Fragment>
        ))}
      </div>
